...
import com.partnership.bjbdocumenttrackerreader.databinding.FragmentSearchAgunanBinding
import com.partnership.bjbdocumenttrackerreader.ui.adapter.SearchAgunanViewPagerAdapter
import com.partnership.bjbdocumenttrackerreader.ui.scan.RFIDViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class SearchAgunanFragment : Fragment(),SingleSearchAgunanFragment.OnAgunanItemClickListener {
    private val rfidViewModel : RFIDViewModel by activityViewModels()
    private var _binding: FragmentSearchAgunanBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSearchAgunanBinding.inflate(inflater, container, false)
        setupToolbar()
        setUpMenu()
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = SearchAgunanViewPagerAdapter(requireActivity())
                ...
                return when (menuItem.itemId) {
                    R.id.readerSetting -> {
                        ...
                        if (isScanning) {
                            ...
                            findNavController().navigate(R.id.action_searchAgunanFragment_to_settingReaderFragment)
                            true
                        }
                    }
    ...
    override fun onAgunanItemClicked(item: DetailAgunan) {
