...
class RadarBackgroundView : View {
...
//        mPaintSector.setShader(mShader);
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in 0..359) {
            if (i % 30 == 0) {
                canvas.drawLine(0f, -r, 0f, -r + len30, mLinePaint!!)
                if (i % 90 != 0) {
                    canvas.drawText(
                ...
                canvas.drawLine(0f, -r, 0f, -r + len5, mLinePaint!!)
            }
            canvas.rotate(1f)
        }

        canvas.drawText("0", 0f, -r + len30 + textLen - 4, mText1Paint!!)
        canvas.rotate(90f)
        canvas.drawText("90", 0f, -r + len30 + textLen - 4, mText1Paint!!)
        canvas.rotate(90f)
        canvas.drawText("180", 0f, -r + len30 + textLen - 4, mText1Paint!!)
        canvas.rotate(90f)
        canvas.drawText("270", 0f, -r + len30 + textLen - 4, mText1Paint!!)
        canvas.restore()
